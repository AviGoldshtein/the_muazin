...
class Manager:
    def __init__(self, consumption_topic, publication_topic, index_name):
        """
        manager initialization with instances of
        Convertor, MongoDal, Producer, ElasticConnector and Logger.
        ...
        self.publication_topic = publication_topic
    ...
    def run(self):
        ...
        for event in events:
            ...
            self.producer.publish_event(self.publication_topic, event={'file_id': file_id})
